              ...
              return (
                <li key={article._id} className="article">
                  ...
                  <div className="articleInfo">
                    ...
                    <button
                      className="showComments clickComment"
                      onClick={(e) => this.handleComments(e)}
                    >
                    ...
                    <div className="comments clickComment">
                      ...
                      {article.comments.length === 0 ? (
                        <p className="noComment clickComment">No comments</p>
                      ) : (
                      ...
                      <div className="newComment clickComment">
                        <label
                          htmlFor={article._id}
                          className="sr-only clickComment"
                        >
                        ...
                        />
                        <button
                          onClick={() => this.handleNewComment(article._id)}
                          className="clickComment"
                        >
                          <FontAwesomeIcon
                            icon={faPlus}
